...
if __name__ == '__main__':
    reg = 3
    ns = [20]#[60, 80, 100, 120, 140, 160, 180, 200]
    seed = 666
    ps= [2]#, 3]#, 2]#, 3]
    num_runs = 1
    print(execute_RQAOA_single_instance_recalculation(ns[0], ps[0], num_runs, 1))
    print(execute_RQAOA_single_instance(ns[0], ps[0], num_runs))
