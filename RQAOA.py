...
class RQAOA_recalculate(QIRO):
    """
    RQAOA is a subclass of QIRO, designed to implement the Recursive Quantum Approximate Optimization Algorithm for combinatorial optimization problems. This recalculation version introduces recalculation intervals in which correlations are not computed again.
    ...
    def __init__(self, expectation_values_input, nc, iteration = 0, recalculations=6, type_of_problem="MAX_2_SAT", connectivity_output=False):
        """
        Initializes the RQAOA instance.
    ...
    def execute(self):
        ...
        while self.problem.graph.number_of_nodes()>self.nc:
            ...
            #Here, recalculation invervals come into play
            if step%self.recalculations==0:
                ...
                try:
                    ...
                    Corkeys = [i for i in expect_val_dict.keys()]
            ...
            #Renaming of correlations during shrinking within on recalculation interval
